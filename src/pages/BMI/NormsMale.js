...
const NormsMale = ({bmi}) => {
    if (bmi < 16) {
        return <div className={["result", "result--3"].join(" ")}><h2 className="result-header">Twoje BMI: {bmi}</h2>
        ...
        return <div className={["result", "result--2"].join(" ")}><h2 className="result-header">Twoje BMI: {bmi}</h2>
        ...
        return <div className={["result", "result-4"].join(" ")}><h2 className="result-header">Twoje BMI: {bmi}</h2>
