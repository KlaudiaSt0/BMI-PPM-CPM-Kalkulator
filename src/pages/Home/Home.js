...
const Home = () => {
    return <main className="container">
        <article className="home_block">
            ...
            <Link to="/BMI" className={["home_btn", "btn-BMI"].join(' ')}>Oblicz BMI <img src={arrow} alt="arrow" name="arrow" className="img"/></Link>
        </article>
        <article className="home_block">
            ...
            <Link to="/PPM"  className={["home_btn", "btn-PPM"].join(' ')}>Oblicz PPM <img src={arrow} alt="arrow" name="arrow" className="img"/></Link>
        </article>
        <article className="home_block">
            ...
            <Link to="/CPM" className={["home_btn", "btn-CPM"].join(' ')}>Oblicz CPM <img src={arrow} alt="arrow" name="arrow" className="img"/> </Link>
        </article>
