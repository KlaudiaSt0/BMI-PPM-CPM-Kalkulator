...
const Home = () => {
    return <div className="container">
        <div className="home_block">
            ...
            <a href="http://localhost:3000/BMI#/BMI" className="home_btn">Oblicz BMI <img src={arrow} alt="arrow" name="arrow" className="img"/></a>
        </div>
        <div className="home_block">
            ...
            <a href="http://localhost:3000/BMI#/PPM" className="home_btn">Oblicz PPM <img src={arrow} alt="arrow" name="arrow" className="img"/></a>
        </div>
        <div className="home_block">
            ...
            <a href="http://localhost:3000/BMI#/CPM" className="home_btn">Oblicz CPM <img src={arrow} alt="arrow" name="arrow" className="img"/> </a>
        </div>
